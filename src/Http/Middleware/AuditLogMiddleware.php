...
namespace AdriCeci\AuditCenter\Http\Middleware;
...
class AuditLogMiddleware
{
    ...
    {
        $this->excludedRoutes = config('audit-center.middleware.excluded_routes', [
        ...
        $this->loggedMethods = config('audit-center.middleware.logged_methods', ['POST', 'PUT', 'PATCH', 'DELETE']);
    }
    ...
    protected function shouldLog(Request $request): bool
    {
        ...
        $apiPrefix = config('audit-center.middleware.api_prefix', 'api');
    ...
    protected function getNewValues(Request $request, Response $response): ?array
    {
        ...
        $sensitiveFields = config('audit-center.middleware.sensitive_fields', [
            'password',
